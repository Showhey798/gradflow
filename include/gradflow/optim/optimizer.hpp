 ...
 *
 * Optimizer is responsible for updating model parameters based on their gradients.
 * This is the abstract base class that defines the common interface for all optimization
 * algorithms.
 *
 * Design principles:
